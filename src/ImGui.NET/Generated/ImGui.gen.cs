...
namespace ImGuiNET
{
    public static unsafe partial class ImGui
    {
        ...
        {
            ImGuiDockNodePtr ret = ImGuiNative.igDockBuilderGetCentralNode(node_id);
            return ret;
        }
        public static ImGuiDockNodePtr DockBuilderGetNode(uint node_id)
        {
            ImGuiDockNodePtr ret = ImGuiNative.igDockBuilderGetNode(node_id);
            return ret;
        }
        ...
        public static bool DebugEditFontLoaderFlags(IntPtr p_font_loader_flags)
        {
            ImGuiFreeTypeLoaderFlags* native_p_font_loader_flags = (ImGuiFreeTypeLoaderFlags*)p_font_loader_flags.ToPointer();
